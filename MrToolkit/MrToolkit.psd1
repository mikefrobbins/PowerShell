...
FunctionsToExport = 'Add-MrStartupVariable', 'ConvertTo-MrHashtable', 'Expand-MrZipFile', 'Find-MrModuleUpdate', 'Get-MrAutoService', 'Get-MrAutoStoppedService',
                    ...
                    'Invoke-MrPesterToSpeech', 'Invoke-MrTDDWorkflow', 'New-DynamicParam', 'New-MrCimSession', 'New-MrFunction', 'New-MrPlanetPowerShellAuthor',
                    'New-MrScriptModule', 'Out-MrReverseString', 'Out-MrSpeech', 'Remove-MrSavedCredential', 'Remove-MrUserVariable', 'Restart-MrServiceOrDie',
                    'Set-MrInternetConnectionSharing', 'Start-MrAutoStoppedService', 'Stop-MrPendingService', 'Test-MrIpAddress', 'Test-MrURL', 'Test-Port',
