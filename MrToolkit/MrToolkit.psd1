...
FunctionsToExport = 'Add-MrStartupVariable', 'ConvertTo-MrHashtable', 'Expand-MrZipFile', 'Find-MrModuleUpdate', 'Get-MrAutoService', 'Get-MrAutoStoppedService',
                    'Get-MrAvailableDriveLetter', 'Get-MrDayLightSavingTime', 'Get-MrEsetUpdateVersion', 'Get-MrExceptionType', 'Get-MrFunctionsToExport', 'Get-MrGeoInformation',
                    'Get-MrGitHubRepositoryInfo', 'Get-MrGitStatus', 'Get-MrHash', 'Get-MrInternetConnectionSharing', 'Get-MrLeapYear', 'Get-MrLeapYear2', 'Get-MrNetFirewallState',
