...
FunctionsToExport = 'Add-MrStartupVariable', 'ConvertTo-MrHashtable', 'Expand-MrZipFile', 'Find-MrModuleUpdate', 'Get-MrAutoService', 'Get-MrAutoStoppedService',
                    ...
                    'Get-MrGeoInformation', 'Get-MrGitHubRepositoryInfo', 'Get-MrGitStatus', 'Get-MrHash', 'Get-MrLeapYear', 'Get-MrLeapYear2', 'Get-MrNetFirewallState',
                    'Get-MrParameterAlias', 'Get-MrPipelineInput', 'Get-MrRemotePSSession', 'Get-MrSavedCredential', 'Get-MrScheduledTask', 'Get-MrUptime', 'Get-MrVHDChain',
                    ...
                    'Remove-MrUserVariable', 'Restart-MrServiceOrDie', 'Start-MrAutoStoppedService', 'Stop-MrPendingService', 'Test-ConsoleColor', 'Test-MrFunctionsToExport',
